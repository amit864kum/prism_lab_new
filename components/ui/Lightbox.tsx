    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex items-center justify-between w-full h-14 px-2 md:px-6">
          <p className="text-sm font-semibold truncate text-slate-350 max-w-md">
        ...
        <div className="flex-1 relative flex items-center justify-center min-h-0 w-full">
          ...
          <div className="w-full h-full max-h-[80vh] flex items-center justify-center p-2 relative">
            <motion.img
              key={currentIndex}
