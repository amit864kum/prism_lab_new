...
import { Users, Plus, Trash2, Edit2, CheckCircle, Search, Mail, BookOpen, Link } from 'lucide-react'
...
export default function MembersPage() {
  ...
  const [role, setRole] = useState<'PhD Scholar' | 'Masters Student' | 'Undergraduate' | 'Research Assistant'>('PhD Scholar')
