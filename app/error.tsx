        ...
        <div className="relative flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-400 max-w-md text-sm md:text-base leading-relaxed">
              We encountered an issue connecting to the database server. This is typical when the server IP is not whitelisted or the local database instance is offline.
            </p>
          </div>
              ...
              {isMongoConnectionError ? (
                <>
                  <li className="flex items-start gap-2.5">
                    ...
                    <div>
                      <strong className="text-slate-200">Whitelist your IP Address:</strong> If using MongoDB Atlas, go to the Network Access section of your Atlas dashboard and ensure your current public IP address is added, or temporarily add <code className="bg-slate-900 border border-slate-800 px-1 py-0.5 rounded text-rose-400">0.0.0.0/0</code> to allow access from anywhere.
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5">
                ...
                <li className="flex items-start gap-2.5">
                  ...
                  <div>
                    <span className="text-slate-200">Message:</span> <code className="bg-slate-900 border border-slate-800 px-1 py-0.5 rounded text-rose-400">{error.message || 'Unknown error occurred'}</code>
                  </div>
                </li>
              )}
            </ul>
