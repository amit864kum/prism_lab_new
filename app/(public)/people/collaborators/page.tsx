                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {collab.domains.map((dom, dIdx) => (
                        <span
                          key={dIdx}
                          className="px-2 py-0.5 rounded bg-slate-50 dark:bg-slate-950 text-slate-650 dark:text-slate-400 text-[10px] font-bold border border-slate-150 dark:border-slate-800"
                        >
                          {dom}
                        </span>
                      ))}
