            ...
            <AnimatePresence mode="popLayout">
              {paginatedProjects.map((project) => (
                <Link
                  ...
                  className="block h-full outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-950 rounded-2xl"
                >
                <motion.article
                  layout
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div
                      className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed prose dark:prose-invert max-w-none"
